...
contract Market is Ownable{
    ...
    function addMarket(string memory name, uint32 _maxLeverage) public onlyOwner{
    ...
    function changeMaxLeverage(uint80 poolId, uint32 _maxLeverage) public onlyOwner {
